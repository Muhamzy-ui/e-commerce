"""
Django settings for My_Jumia project.
...
SECRET_KEY = 'django-insecure-32r+_09-0d$#@_%0#=zo)iv+8^ol6ftp=#$fpnjamzrp^u)*fc'
...
INSTALLED_APPS = [
    ...
    'wishlist.apps.WishlistConfig', # Explicitly refer to the configuration class
